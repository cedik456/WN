    ...
    <View className="flex-1 bg-black">
      <SafeAreaView className="justify-between flex-1 px-6 py-10 bg-black">
        ...
        <View className="items-center flex-1 space-y-2 mt-60 ">
          ...
          <Text className="text-sm font-medium text-white">Swipe, Match, Hire</Text>
        </View>
        ...
        <View className="flex-1">
          ...
          <Pressable className="items-center p-4 m-2 bg-white rounded-full">
            <Text className="font-medium text-black">Create account with Email</Text>
          </Pressable>

          <Pressable className="items-center p-4 m-2 bg-white rounded-full" onPress={() => router.push('/(auth)/signup')}>
            <Text className="font-medium text-black">Use cell phone number</Text>
          </Pressable>
        </View>

        {/* Footer */}
        <View className="items-center mt-6 mb-10">
          <Text className="text-sm text-white underline">Trouble signing in?</Text>
        </View>
      </SafeAreaView>
    </View>
  );
