...
export default function EmployerSkillsScreen() {
  ...
  const handleNext = () => {
    if (selectedSkills.length >= 3 && selectedSkills.length <= 8) {
      ...
      router.push(`/${selectedRole}/step6`);
    }
  };
    ...
    <View className="relative flex-1">
      <ScrollView className="px-6 pt-6 pb-28">
        <Text className="text-4xl font-bold mb-2">
          {`Let’s talk about the skills your candidates should have!`}
        </Text>

        <Text className="text-md text-gray-600 mb-5">
          Choose 3 to 8 professional skills that reflect the expertise of your ideal candidates.
        </Text>
        ...
        <Text className="text-gray-600 text-md">
          This information will help your organization find suitable candidates.
        </Text>
      </ScrollView>
